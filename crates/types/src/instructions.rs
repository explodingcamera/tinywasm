...
pub enum Instruction {
    ...
    StructNew(TypeAddr),
    StructNewDefault(TypeAddr),
    StructGet(TypeAddr, u32),
    StructGetS(TypeAddr, u32),
    StructGetU(TypeAddr, u32),
    StructSet(TypeAddr, u32),
    ArrayNew(TypeAddr),
    ArrayNewDefault(TypeAddr),
    ArrayNewFixed(TypeAddr, u32),
    ArrayNewData(TypeAddr, DataAddr),
    ArrayNewElem(TypeAddr, ElemAddr),
    ArrayGet(TypeAddr),
    ArrayGetS(TypeAddr),
    ArrayGetU(TypeAddr),
    ArraySet(TypeAddr),
    ArrayLen,
    ArrayFill(TypeAddr),
    ArrayCopy(TypeAddr, TypeAddr),
    ArrayInitData(TypeAddr, DataAddr),
    ArrayInitElem(TypeAddr, ElemAddr),
