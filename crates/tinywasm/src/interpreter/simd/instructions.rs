...
impl Value128 {
    ...
    pub(crate) fn i8x16_popcnt(self) -> Self {
    ...
    pub(crate) fn i8x16_avgr_u(self, rhs: Self) -> Self {
        simd_avgr_u!(self, rhs, u8x16_avgr, u8, u16, as_u8x16, from_u8x16)
    }

    #[doc(alias = "i16x8.avgr_u")]
    pub(crate) fn i16x8_avgr_u(self, rhs: Self) -> Self {
    ...
    pub(crate) fn i16x8_relaxed_q15mulr_s(self, rhs: Self) -> Self {
    ...
    pub(crate) fn f32x4_relaxed_min(self, rhs: Self) -> Self {
        self.f32x4_min(rhs)
    }

    #[doc(alias = "f64x2.relaxed_min")]
    pub(crate) fn f64x2_relaxed_min(self, rhs: Self) -> Self {
        self.f64x2_min(rhs)
    }

    #[doc(alias = "f32x4.relaxed_max")]
    pub(crate) fn f32x4_relaxed_max(self, rhs: Self) -> Self {
        self.f32x4_max(rhs)
    }

    #[doc(alias = "f64x2.relaxed_max")]
    pub(crate) fn f64x2_relaxed_max(self, rhs: Self) -> Self {
        self.f64x2_max(rhs)
    }

    #[doc(alias = "i32x4.relaxed_trunc_f32x4_s")]
    pub(crate) fn i32x4_relaxed_trunc_f32x4_s(self) -> Self {
        self.i32x4_trunc_sat_f32x4_s()
    }

    #[doc(alias = "i32x4.relaxed_trunc_f32x4_u")]
    pub(crate) fn i32x4_relaxed_trunc_f32x4_u(self) -> Self {
        self.i32x4_trunc_sat_f32x4_u()
    }

    #[doc(alias = "i32x4.relaxed_trunc_f64x2_s_zero")]
    pub(crate) fn i32x4_relaxed_trunc_f64x2_s_zero(self) -> Self {
        self.i32x4_trunc_sat_f64x2_s_zero()
    }

    #[doc(alias = "i32x4.relaxed_trunc_f64x2_u_zero")]
    pub(crate) fn i32x4_relaxed_trunc_f64x2_u_zero(self) -> Self {
        self.i32x4_trunc_sat_f64x2_u_zero()
    }

    #[doc(alias = "i32x4.trunc_sat_f32x4_s")]
    pub(crate) fn i32x4_trunc_sat_f32x4_s(self) -> Self {
        Self::from_i32x4(self.as_f32x4().map(trunc_sat_f32_to_i32))
    }

    #[doc(alias = "i32x4.trunc_sat_f32x4_u")]
    pub(crate) fn i32x4_trunc_sat_f32x4_u(self) -> Self {
    ...
    pub(crate) fn f32x4_convert_i32x4_s(self) -> Self {
        Self::from_f32x4(self.as_i32x4().map(|x| x as f32))
    }

    #[doc(alias = "f32x4.convert_i32x4_u")]
    pub(crate) fn f32x4_convert_i32x4_u(self) -> Self {
